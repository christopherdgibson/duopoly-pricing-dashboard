class MarketBenchmarks:
    ...
    symmetric linear duopoly:
        q_i = a - p_i + b*(p_j - p_i)
    """
    def __init__(self, a: float = 100.0, b: float = 2.0, cost: float = 5.0):
        self.a = a
        self.b = b
        self.cost = cost
    ...
    def compute_profit(self, p1: float, p2: float) -> tuple[float, float]:
        ...
        profit1 = (p1 - self.cost) * q1
        profit2 = (p2 - self.cost) * q2
